import { orgsEPs } from "../Config.json";
import Socket from "../util/Socket";

const { detailsEP, getOrgsEP  } = orgsEPs;

async function getOrgs() {

  console.log("PATH: " + getOrgsEP)

  return await Socket.GET(getOrgsEP);
}
async function details(org_id) {
  let path = ""
